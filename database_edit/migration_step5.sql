...
CREATE OR REPLACE FUNCTION public.reset_machine(p_machine_id UUID, p_wipe_history BOOLEAN DEFAULT FALSE)
RETURNS VOID AS $$
BEGIN
  ...
  SET overall_health = 100, status = 'healthy', updated_at = NOW()
