    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="card w-full max-w-md relative">
        ...
        <div className="space-y-2 mb-5">
          <label className="flex items-center gap-2 cursor-pointer p-3 rounded-lg bg-gray-900/40 border border-gray-800">
            <input type="checkbox" checked={resetRuntime} onChange={e => setResetRuntime(e.target.checked)}
              className="w-4 h-4 rounded accent-indigo-600" />
            <span className="text-sm text-gray-300">Also reset runtime hours to 0 (factory-fresh)</span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer p-3 rounded-lg bg-gray-900/40 border border-gray-800">
