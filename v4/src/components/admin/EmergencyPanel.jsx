...
export default function EmergencyPanel() {
  ...
  return (
    <div className="card border-red-900/50">
      ...
      {active.length > 0 ? (
        <div>
          <div className="emergency-banner rounded-lg px-4 py-3 mb-3 text-gray-900 flex items-center gap-2">
        ...
        <div>
          <p className="text-sm text-gray-700 mb-1">Confirm broadcast to all machines?</p>
