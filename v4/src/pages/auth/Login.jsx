    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-50">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-gray-900">AGV Predictive Maintenance</h1>
        ...
        <form onSubmit={handleSubmit} className="card space-y-4">
          ...
          {error && (
            <div className="text-sm text-red-600 bg-red-50 border border-red-300 rounded-lg px-3 py-2">
              {error}
            </div>
          )}
        ...
        {/* Demo quick login */}
        <p className="text-center text-xs text-gray-400 mt-4 mb-2">Trying the demo? One click fills the credentials:</p>
