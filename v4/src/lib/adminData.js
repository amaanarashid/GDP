...
// ── Hard delete (permanent — cascades to components, sensors,
// readings, predictions, alerts and maintenance logs) ────────
export async function deleteMachine(id) {
  // emergency_broadcasts.machine_id has no ON DELETE CASCADE — detach first
  await supabase.from('emergency_broadcasts').update({ machine_id: null }).eq('machine_id', id)
