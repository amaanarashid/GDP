...
import { writeReadings, updateSensorValues, updateComponentHealth, refreshMachineHealth, createAlert } from '../lib/data'
...
export function useSimulator({ machine, components, sensors, onUpdate }) {
  ...
  const tick = useCallback(async () => {
    ...
    // 5. Push to UI
    onUpdate?.({ sensors: updatedSensors, components: updatedComponents })
    setTickCount(t => t + 1)
